...
const Check_out = () => {
  return (
    <div className=" h-[1210px] w-[1210px] m-auto  ">
      ...
      <div className=" flex gap-[173px] py-10">
        <div className=" w-full max-w-md p-6 ">
          <h2 className="text-[36px] leading-[30px] tracking-[4%] font-medium mb-12">Billing Details</h2>
          ...
          <div className="mb-8">
            ...
            <input
              type="text"
              className="w-full bg-F5F5F5p-3 rounded outline-none"
            />
          </div>
          ...
          <div className="space-y-3 mb-4">
            ...
            <label className="flex items-center justify-between cursor-pointer">
              ...
              <div className="flex gap-2 items-center text-xs">
                ...
                <span><img src={nagad} alt="Nagad" /></span>
              </div>
