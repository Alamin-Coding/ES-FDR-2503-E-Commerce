...
const StatCard = ({ Icon, title, description }) => {
	...
	return (
		<div
			className="group bg-white rounded-sm text-center text-black w-[270px] border border-[#C1C0C1] transition-all duration-300 ease-in-out hover:bg-my_secondary hover:text-white hover:border-secondary hover:cursor-pointer hover:scale-100 hover:shadow-2xl"
