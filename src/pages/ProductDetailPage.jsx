            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="border border-[#000000]/50 pt-6 rounded ">
                <div className="flex items-center gap-4 pb-4 border-b border-[#000000]/50 pl-4">
                  ...
                  <p className="text-[12px] leading-[1.5] font-medium">Enter your postal code for Delivery Availability</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 pt-4 pb-6 pl-4">
                  ...
                  <p className="text-[12px] leading-[1.5] font-medium">Free 30 Days Delivery Returns. Details</p>
                  </div>
                </div>
              </div>
            </div>
